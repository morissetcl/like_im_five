...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Like Im Five generate a file with factories you need to test a specific object. It use you development database to retrieve the object you want and all associations you will have need to setup the test."
